...
public class PantallaPresentacion implements Screen,InputProcessor {
    ...
    Rectangle rectangleIniciar;
    Rectangle rectangleSalir;

    public PantallaPresentacion(JuegoAndroid juegoAndroid){
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        ...
        if(Intersector.overlaps(dedo,rectangleIniciar))
            juegoAndroid.setScreen(new PantallaJuego(juegoAndroid));
    ...
    public void show() {
        ...
        texture= MiAssetsManager.getManager().get("pantallaInicio.png", Texture.class);
        rectangleIniciar=new Rectangle(0,MiMundo.ALTO-170,470,75);
        rectangleSalir=new Rectangle(100,MiMundo.ALTO-270,180,65);
    ...
    public void render(float delta) {
        ...
        shapeRenderer.rect(rectangleIniciar.x, rectangleIniciar.y, rectangleIniciar.width, rectangleIniciar.height);
